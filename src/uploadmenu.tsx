...
function UploadMenu() {
    ...
    const [fileDataState, setFileDataState] = useState<Uint8Array | undefined>(undefined)
    const [fileState, setFileState] = useState<File | undefined>(undefined)
    const [buttonIsDisplayingUndefined, setButtonIsDisplayingUndefined] = useState(false)
